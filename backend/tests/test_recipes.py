...
def profile():
    return {'version': 'mock-profile-1', 'temperature_max_c': 1600, 'ramp_max_c_min': 10,
            'n2_max_l_min': 5, 'co_max_l_min': 2, 'co_min_furnace_c': 500,
            'safe_end_burden_c': 200, 'max_stages': 32, 'rules_reference': 'mock-only'}
