...
2026-09-14 用户确认 GitHub Actions 预算已恢复，重新运行的检查已实际启动；实际 Windows 安装验收与正式发布尚未完成。PR #79 保持 draft、未合并，未创建 `v0.3.0` 标签，详见[预算恢复及已执行检查](verification/2026-09-13-overwrite-install.md#本轮-windows-ci-与预算阻塞)。
