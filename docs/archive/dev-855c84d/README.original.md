...
> 完整项目宪章见 [`CLAUDE.md`](../../../CLAUDE.md)，详细规格见 [`docs/`](../..)。
> 接口对齐待办（依赖供应商交付物）见 [`docs/待确认事项与接口对齐清单.md`](../../待确认事项与接口对齐清单.md)。
...
[`docs/发布与维护指南.md`](../../发布与维护指南.md)，变更记录见 [`CHANGELOG.md`](../../../CHANGELOG.md)。
