...
文档修订：`2.0-doc.4`，2026-09-20。当前交底基线为已发布的 SmdHmi `0.3.0`，完整提交和版本关系见[修订记录](revisions.md)。HOST-2006—2009 的 rc.5 软件与 Windows 证据保留为[历史安装版验证](../../verification/2026-09-08-installed-hostcomm-loop.md)，0.3.0 发行证据见[正式版验证](../../verification/2026-09-13-overwrite-install.md)。目标 STM32 固件开发中、尚未交付验收，不能把文档升级或模拟器通过解释为双方已经完全匹配。
...
| ALIGN-10 | 现行入口仍混用doc.2/doc.3和rc.5，固件状态仍写尚未开发 | doc.4统一以0.3.0为交底基线，新增[技术交底](technical-briefing.md)及离线阅读入口；原Schema/向量与线协议不变，真实固件和工程资料继续待验 |
