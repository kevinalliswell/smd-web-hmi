...
文档修订：`2.0-doc.2`，2026-09-07。适配对象为 SmdHmi `0.3.0-rc.4`；线上仍使用 `protocol_version="2.0"`、`design_revision="2.0-design.1"`。文档修订号不能填入报文。源码、候选包与文档的版本关系见[修订记录](revisions.md)。
