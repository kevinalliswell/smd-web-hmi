...
文档修订：`2.0-doc.3`，2026-09-07。适配对象为本轮 SmdHmi `0.3.0-rc.5` 开发候选；线上仍使用 `protocol_version="2.0"`、`design_revision="2.0-design.1"`。文档修订号不能填入报文。源码、候选包与文档的版本关系见[修订记录](revisions.md)。
...
| H1 安装版软件联调 | 当前Windows安装版连接同机TLS模拟器；桌面和浏览器共用后台 | 身份握手、遥测、配方回读、运行/停止/冷却、归档及断线补传记录；当前仍待做 |
