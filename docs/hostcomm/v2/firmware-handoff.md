...
文档修订：`2.0-doc.3`，2026-09-08。适配对象为本轮 SmdHmi `0.3.0-rc.5` 开发候选；线上仍使用 `protocol_version="2.0"`、`design_revision="2.0-design.1"`。文档修订号不能填入报文。源码、候选包与文档的版本关系见[修订记录](revisions.md)。
...
| H1 安装版软件联调 | 独立SmdBench已实现，连接本轮安装版服务与同机TLS模拟器，通过Chromium操作共用后台 | 身份握手、配方、运行/停止/冷却、归档、报告及补传的同提交执行证据；完整Windows结果仍待取得，见[本轮验证](../../verification/2026-09-08-installed-hostcomm-loop.md)；Win10/11 WebView2人工验收另列M4 |
